...
#https://discussions.udacity.com/t/safety-a-and-reliability-f-help-please/219133
...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        #self.epsilon = 1/self.count

        #self.epsilon -= 0.05
        #self.epsilon = self.epsilon * 1.0/ ((self.count+1))
        #self.epsilon -= 0.05
        ...
        if self.learning == False:
            ...
            if self.epsilon > random.random():
                ...
                for action in action_list:
                    if self.Q[state][action] >= max_score:
                        maxQ_list.append(action)
                action = random.choice(maxQ_list)
